...
function handleAddLike(event) {
    ...
    let targetToChangeIcon = button.querySelector('.fa-heart');
    ...
    $.ajax({
        ...
        success: function (data, dataType) {
            ...
            if (data === '+1') {
                ...
                $(targetToChangeIcon).removeClass("far fa-heart");
                $(targetToChangeIcon).addClass("fa fa-heart");

            } else {
                $(targetToChangeIcon).removeClass("fa fa-heart");
                $(targetToChangeIcon).addClass("far fa-heart");
                targetToChange.innerText = parseInt(targetToChange.innerText) - 1;
